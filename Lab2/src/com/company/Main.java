...
public class Main
{
	public static void main(String[] args)
	{
	    ...
	    // DynArray
	    DynArray darr1 = new DynArray();
	    DynArray darr2 = new DynArray(10);
	    DynArray darr3 = new DynArray(3, new Object[] {10, 11, null});

	    System.out.println("DynArray1: " + darr1);
	    System.out.println("DynArray2: " + darr2);
